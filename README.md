# EduFLOW
EDUFLOW is an AI featured academic task manager which aids students manage their day to day activities including quizzes, assignments,helps students build 48 hour study plans...

## 📍The Problem

Every student has faced this: Multiple deadlines approaching , but which do you work on first? 
...
3. **Extract tasks** such as :slides , pdf files , document files

4. **Detects Burnouts** when you have 3+ deadlines in 5 days
